# -*- coding: utf-8 -*-
"""Собирает PDF из SF4030T-5S_RU.md (кириллица + CJK-фолбэк)."""
import re
...
def decorate(canv, doc):
    ...
    if doc.page > 1:
        ...
        canv.drawString(2 * cm, A4[1] - 1.25 * cm, 'SF4030T-5S — Руководство по эксплуатации')
...
doc = BaseDocTemplate('SF4030T-5S_Руководство_RU.pdf', pagesize=A4,
                      ...
                      title='SF4030T-5S — Руководство по эксплуатации (перевод с китайского)',
                      author='Shandong Chencan Machinery Equipment Co., Ltd.',
                      subject='Портальный обрабатывающий центр SF4030T-5S')
